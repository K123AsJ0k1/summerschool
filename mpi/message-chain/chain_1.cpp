...
int main(int argc, char *argv[]) {
    ...
    MPI_Send(&message, numElements, MPI_INT, destination, rank, MPI_COMM_WORLD);
    ...
    MPI_Recv(&receiveBuffer, numElements, MPI_INT, source, source, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
